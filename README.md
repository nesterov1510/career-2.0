...
* На **главной странице** автоматически показываются карточки активных сайтов и вакансий с кнопками «Откликнуться» и «Посмотреть вакансии сайта».
...
* **Скрытая админ-панель**: самостоятельное добавление и редактирование сайтов и вакансий, публикация/скрытие карточек на главной, ссылки, заявки со статусами, настройки бота, смена пароля.
...
1. В админ-панели откройте **💼 Сайты и вакансии** → «Добавить вакансию»:
   * название: `TV Repair by Meryosab`
   * ссылка на все вакансии сайта: `https://tvrepair.meryosab.com/vacancies/`
   * название вакансии: `Мастер по ремонту компьютеров и ноутбуков`
...
* Возможности: дашборд со статистикой, добавление и редактирование сайтов/вакансий, публикация карточек
  на главной, управление токенами, список и карточки заявок, статусы (Новая → Связались → Принят /
  Отклонена), скачивание резюме, повторная отправка в Telegram, настройки бота, смена пароля.
